...
export function VesselFinderMap({ imo, mmsi, vesselName, className }: VesselFinderMapProps) {
  // Construct VesselFinder URLs
  const mapUrl = imo 
    ? `https://www.vesselfinder.com/?imo=${imo}`
    : mmsi 
      ...
      <Card className={className}>
        <CardContent className="pt-6">
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>Map unavailable</p>
            <p className="text-sm">IMO or MMSI required for map display</p>
          </div>
        </CardContent>
      </Card>
    );
