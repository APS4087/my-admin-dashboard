  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        ...
        <Marker position={[location.latitude, location.longitude]} icon={shipIcon}>
          <Popup>
            <div className="min-w-[200px] space-y-2">
              <div className="border-b pb-2 text-center font-semibold">{shipEmail}</div>
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div>
                  ...
                  <span className="flex items-center">
                    ...
                    <svg className="ml-1 h-3 w-3" style={courseArrowStyle} viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  ...
                  <span
                    className={`inline-block rounded px-2 py-1 text-xs ${
                      location.status === "Underway" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
                    }`}
                  >
                    {location.status}
                  </span>
              ...
              {location.port && (
                <div className="border-t pt-2">
                  <span className="text-xs font-medium">Near: </span>
      ...
      <div className="absolute top-4 right-4 z-[1000] rounded-lg bg-white/90 p-3 shadow-lg backdrop-blur">
        <div className="space-y-1 text-sm">
          ...
          <div className="flex items-center text-xs text-gray-600">
            <svg className="mr-1 h-3 w-3" style={courseArrowStyle} viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2l8 10h-6v10H10V12H4l8-10z" />
            </svg>
            {location.course.toFixed(0)}°
          </div>
